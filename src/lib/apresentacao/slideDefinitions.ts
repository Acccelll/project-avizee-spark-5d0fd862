...
export const APRESENTACAO_SLIDES_V2: SlideDefinition[] = [
  ...
  { codigo: 'highlights_financeiros', titulo: 'Highlights Financeiros', subtitulo: 'Resumo executivo do período', chartType: 'cards', dependencies: ['vw_apresentacao_highlights_financeiros'], expectedDatasets: ['kpis'], required: true, optional: false, dependsOn: [], order: 2, hiddenWhenEmpty: false, modeSupport: ['dinamico', 'fechado'], secao: 'financeiro', dataSchema: { cardKeys: ['faturamento', 'despesa', 'resultado', 'caixa'] } },
  { codigo: 'faturamento', titulo: 'Faturamento', subtitulo: 'Evolução e composição', chartType: 'coluna', dependencies: ['vw_apresentacao_faturamento'], expectedDatasets: ['serie_mensal'], required: true, optional: false, dependsOn: [], order: 3, hiddenWhenEmpty: false, modeSupport: ['dinamico', 'fechado'], secao: 'financeiro', dataSchema: { arrayKey: 'serie', labelField: 'competencia', valueField: 'valor' } },
  { codigo: 'despesas', titulo: 'Despesas', subtitulo: 'Consolidação por competência', chartType: 'coluna', dependencies: ['vw_apresentacao_despesas'], expectedDatasets: ['serie_mensal'], required: true, optional: false, dependsOn: [], order: 4, hiddenWhenEmpty: false, modeSupport: ['dinamico', 'fechado'], secao: 'financeiro', dataSchema: { arrayKey: 'serie', labelField: 'competencia', valueField: 'valor' } },
  { codigo: 'rol_caixa', titulo: 'Caixa / ROL', subtitulo: 'Posição de liquidez', chartType: 'cards', dependencies: ['vw_apresentacao_rol_caixa'], expectedDatasets: ['caixa_total'], required: true, optional: false, dependsOn: [], order: 5, hiddenWhenEmpty: false, modeSupport: ['dinamico', 'fechado'], criticalInClosedMode: true, secao: 'financeiro', dataSchema: { cardKeys: ['rol', 'caixa_total', 'cobertura_pct'] } },
  { codigo: 'receita_vs_despesa', titulo: 'Receita vs Despesa', subtitulo: 'Comparativo mensal', chartType: 'linha', dependencies: ['vw_apresentacao_receita_vs_despesa'], expectedDatasets: ['receita', 'despesa'], required: true, optional: false, dependsOn: [], order: 6, hiddenWhenEmpty: false, modeSupport: ['dinamico', 'fechado'], secao: 'financeiro', dataSchema: { arrayKey: 'serie', labelField: 'competencia', valueFields: ['receita', 'despesa'] } },
  ...
  { codigo: 'fluxo_caixa', titulo: 'Fluxo de Caixa', subtitulo: 'Entradas e saídas', chartType: 'linha', dependencies: ['vw_apresentacao_fluxo_caixa'], expectedDatasets: ['fluxo'], required: true, optional: false, dependsOn: [], order: 8, hiddenWhenEmpty: false, modeSupport: ['dinamico', 'fechado'], criticalInClosedMode: true, secao: 'financeiro', dataSchema: { arrayKey: 'serie', labelField: 'competencia', valueField: 'saldo' } },
  { codigo: 'lucro_produto_cliente', titulo: 'Lucro por Produto e Cliente', subtitulo: 'Top contribuições', chartType: 'barra_horizontal', dependencies: ['vw_apresentacao_lucro_produto_cliente'], expectedDatasets: ['top_produtos', 'top_clientes'], required: true, optional: false, dependsOn: [], order: 9, hiddenWhenEmpty: false, modeSupport: ['dinamico', 'fechado'], secao: 'comercial', dataSchema: { arrayKey: 'top_produtos', labelField: 'nome', valueField: 'lucro' } },
  ...
  { codigo: 'venda_estado', titulo: 'Venda por Estado', subtitulo: 'Distribuição geográfica', chartType: 'barra_horizontal', dependencies: ['vw_apresentacao_venda_estado'], expectedDatasets: ['uf'], required: true, optional: false, dependsOn: [], order: 11, hiddenWhenEmpty: false, modeSupport: ['dinamico', 'fechado'], secao: 'comercial', dataSchema: { arrayKey: 'ranking', labelField: 'estado', valueField: 'faturamento' } },
  { codigo: 'redes_sociais', titulo: 'Redes Sociais', subtitulo: 'Indicadores de crescimento', chartType: 'cards', dependencies: ['vw_apresentacao_redes_sociais'], expectedDatasets: ['social'], required: true, optional: false, dependsOn: [], order: 12, hiddenWhenEmpty: false, modeSupport: ['dinamico', 'fechado'], secao: 'marketing', dataSchema: { cardKeys: ['total_seguidores'] } },

  { codigo: 'bridge_ebitda', titulo: 'Bridge EBITDA', subtitulo: 'Pontes de variação do resultado operacional', chartType: 'waterfall', dependencies: ['vw_apresentacao_bridge_ebitda'], expectedDatasets: ['impactos'], required: false, optional: true, dependsOn: ['mapeamento_gerencial_contas'], order: 13, hiddenWhenEmpty: true, modeSupport: ['dinamico', 'fechado'], secao: 'financeiro', dataSchema: { arrayKey: 'steps', labelField: 'label', valueField: 'valor' } },
  { codigo: 'bridge_lucro_liquido', titulo: 'Bridge Lucro Líquido', subtitulo: 'Reconciliação até lucro líquido', chartType: 'waterfall', dependencies: ['vw_apresentacao_bridge_lucro_liquido'], expectedDatasets: ['impactos'], required: false, optional: true, dependsOn: ['mapeamento_gerencial_contas'], order: 14, hiddenWhenEmpty: true, modeSupport: ['dinamico', 'fechado'], secao: 'financeiro', dataSchema: { arrayKey: 'steps', labelField: 'label', valueField: 'valor' } },
  { codigo: 'dre_gerencial', titulo: 'P&L / DRE Gerencial', subtitulo: 'Consolidado por linhas gerenciais', chartType: 'stacked', dependencies: ['vw_apresentacao_dre_gerencial'], expectedDatasets: ['linhas_dre'], required: false, optional: true, dependsOn: ['mapeamento_gerencial_contas'], order: 15, hiddenWhenEmpty: true, modeSupport: ['dinamico', 'fechado'], secao: 'financeiro', dataSchema: { cardKeys: ['receita_bruta', 'deducoes', 'receita_liquida', 'fopag', 'despesa_operacional', 'ebitda'] } },
  { codigo: 'capital_giro', titulo: 'Capital de Giro', subtitulo: 'Working capital consolidado', chartType: 'cards', dependencies: ['vw_apresentacao_capital_giro'], expectedDatasets: ['capital_giro'], required: false, optional: true, dependsOn: ['vw_workbook_aging_cr', 'vw_workbook_aging_cp'], order: 16, hiddenWhenEmpty: true, modeSupport: ['dinamico', 'fechado'], secao: 'financeiro', dataSchema: { cardKeys: ['contas_receber', 'contas_pagar', 'valor_atual'] } },
  ...
  { codigo: 'resultado_financeiro', titulo: 'Resultado Financeiro', subtitulo: 'Receitas e despesas financeiras', chartType: 'coluna', dependencies: ['vw_apresentacao_resultado_financeiro'], expectedDatasets: ['resultado_financeiro'], required: false, optional: true, dependsOn: ['financeiro_lancamentos'], order: 18, hiddenWhenEmpty: true, modeSupport: ['dinamico', 'fechado'], secao: 'financeiro', dataSchema: { cardKeys: ['valor_atual'] } },
  { codigo: 'tributos', titulo: 'Tributos', subtitulo: 'Carga tributária no período', chartType: 'coluna', dependencies: ['vw_apresentacao_tributos'], expectedDatasets: ['tributos'], required: false, optional: true, dependsOn: ['notas_fiscais'], order: 19, hiddenWhenEmpty: true, modeSupport: ['dinamico', 'fechado'], secao: 'financeiro', dataSchema: { cardKeys: ['icms', 'pis', 'cofins', 'ipi'] } },
  { codigo: 'aging_consolidado', titulo: 'Aging Consolidado (CR + CP)', subtitulo: 'Curva de vencimentos consolidada', chartType: 'stacked', dependencies: ['vw_apresentacao_aging_consolidado'], expectedDatasets: ['aging'], required: false, optional: true, dependsOn: ['vw_workbook_aging_cr', 'vw_workbook_aging_cp'], order: 20, hiddenWhenEmpty: true, modeSupport: ['dinamico', 'fechado'], criticalInClosedMode: true, secao: 'risco', dataSchema: { cardKeys: ['cr_aberto', 'cp_aberto'] } },
